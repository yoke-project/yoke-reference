...
| **Planning item** | yoke-project/yoke-reference#3 |

## yoke-reference:continuous-integration.01 — every proposed change runs the verbs, and nothing else does work
...
## yoke-reference:continuous-integration.02 — what a run needs is declared, not taken from the runner
