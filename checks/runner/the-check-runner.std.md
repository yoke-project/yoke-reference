...
| **Planning item** | yoke-project/yoke-reference#12 |

## yoke-reference:the-check-runner.01 — a check whose name holds a digit is run
...
## yoke-reference:the-check-runner.02 — a marker whose check cannot be found is reported as failing
