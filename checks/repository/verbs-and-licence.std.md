...
| **Planning item** | yoke-project/yoke-reference#2 |

## yoke-reference:verbs-and-licence.01 — every verb is defined, and none is silent
...
## yoke-reference:verbs-and-licence.02 — nothing resolves a path outside the repository
...
## yoke-reference:verbs-and-licence.03 — the repository builds in the container it defines itself
...
## yoke-reference:verbs-and-licence.04 — the licence is the one this repository's role assigns
...
## yoke-reference:verbs-and-licence.05 — `develop` fails on a runner older than the floor
...
## yoke-reference:verbs-and-licence.06 — `fmt` fails on an unformatted tree
...
| **Not applicable in** | — |
| **Label** | blocking |
| **Precondition** | a copy of the checkout with one Go file left unformatted |
